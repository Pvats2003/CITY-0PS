  ...
  return (
    <>
      <header className="flex md:hidden items-center gap-2 h-14 border-b border-border bg-surface px-3">
        <button onClick={() => setOpen(true)} aria-label="Open menu" className="p-2 -ml-2 rounded-md hover:bg-surface-2">
        ...
        <button onClick={() => setPaletteOpen(true)} aria-label="Open command palette" className="p-2 rounded-md hover:bg-surface-2">
        ...
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-64 bg-surface border-r border-border p-2 flex flex-col">
            <div className="flex items-center justify-between px-2 py-2">
              ...
              <button onClick={() => setOpen(false)} aria-label="Close menu" className="p-1.5 rounded-md hover:bg-surface-2">
                <X className="size-4" />
              </button>
            </div>
